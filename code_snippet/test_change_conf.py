...
Hosts = ['10.66.129.90','10.66.129.174','10.66.129.42','10.66.129.75','10.66.129.78','10.66.129.79','10.66.129.81','10.66.129.80']
PLATFORM = "WINDOWS"
...
for host in Hosts:
	...
	ssh.connect(host, username='Administrator', password='QWE123asd')
